 ...
 *   }
 */
const hapiType = new _graphql.GraphQLObjectType({
    name: 'Hapi',
    ...
    fields: () => ({
        ...
        related: {
            ...
            resolve: id => (0, _data.getRelated)(id)
        },
        description: {
            type: _graphql.GraphQLString,
            description: 'Description of the repository.'
 ...
 *   }
 */
const TopicType = new _graphql.GraphQLObjectType({
    name: 'Topic',
    fields: {
        id: {
            type: (0, _graphql.GraphQLNonNull)(_graphql.GraphQLString),
 ...
 *   }
 */
const xHapiType = new _graphql.GraphQLObjectType({
    name: 'xHapi',
    ...
    fields: () => ({
        ...
        related: {
            type: (0, _graphql.GraphQLList)(repositoryInterface),
            description: 'The repositories related to this project.',
            resolve: xHapiRecord => (0, _data.getRelated)(xHapiRecord)
        },
        description: {
            type: _graphql.GraphQLString,
            description: 'Description of the repository.'
        ...
        topics: {
            type: (0, _graphql.GraphQLList)(TopicType),
            description: 'Topics related to this project. An Array of strings.',
            resolve: xHapiRecord => (0, _data.getTopics)(xHapiRecord)
        }
    }),
    interfaces: [repositoryInterface]
});
...
const queryType = new _graphql.GraphQLObjectType({
    ...
    fields: () => ({
        getRepository: {
            ...
            resolve: (root, { id }) => (0, _data.getRepository)(id) // method imported from data.js.
        }
    })
});
