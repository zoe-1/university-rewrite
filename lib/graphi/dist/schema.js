...
var repositoryInterface = new _graphql.GraphQLInterfaceType({
    ...
    resolveType: function resolveType(repository) {
 ...
 *   }
 */
var xHapiType = new _graphql.GraphQLObjectType({
    name: 'xHapi',
    ...
    fields: function fields() {
        return {
            ...
            related: {
                type: (0, _graphql.GraphQLList)(repositoryInterface),
                description: 'The repositories related to this project.',
                resolve: function resolve(xHapiRecord) {
                    return (0, _data.getRelated)(xHapiRecord);
                }
            },
            description: {
                type: _graphql.GraphQLString,
            ...
            topics: {
                ...
                resolve: function resolve(xHapiRecord) {
                    return (0, _data.getTopics)(xHapiRecord);
                }
            }
        };
    },
